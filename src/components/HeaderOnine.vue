        ...
        <div class="container">
            <div class="ht-left">
                <div class="mail-service">
                    <i class=" fa fa-envelope"></i> hello.onine@gmail.com
                </div>
                <div class="phone-service">
                    <i class=" fa fa-phone"></i> +62 878-5626-6060
                </div>
            </div>
        </div>
    </div>
                        ...
                        <li class="cart-icon">
                            ...
                            <div class="cart-hover">
                                ...
                                <div class="select-button">
                                    <router-link to="/cart" style="color : #fff;" class="primary-btn view-card">
                                        VIEW CARD
                                    </router-link> 
